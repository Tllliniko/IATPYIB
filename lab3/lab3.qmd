...
subtitle: "Отчет "
author: "tolmchevniki04@yandex.ru@yandex.ru"
format: 
  md:
...
## Оценка результата
  ...
  В ходе лабораторной работы мы приобрели практические навыки работы с функциями пакета dplyr, такими как select(), filter(), mutate(), arrange() и group_by(), для обработки данных.

## Вывод

В конечном итоге, можно сказать, что мы укрепили понимание основных типов данных в языке R и улучшили практические навыки работы с функциями обработки данных из пакета dplyr, включая select(), filter(), mutate(), arrange() и group_by().